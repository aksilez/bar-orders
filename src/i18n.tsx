...
const STRINGS = {
  en: {
    ...
    pinSection: 'PIN (Menu, Overview, History)',
    ...
    firstPartName: 'First part name',
    secondPartName: 'Second part name',
    newPartName: 'New part name',
    mergeSplit: 'Merge parts',
    mergeShort: 'Merge',
    mergeTitle: 'Merge parts',
    mergePickHint: 'Tap the part to merge into “{0}”.',
    mergeAll: 'Merge all parts',
    part: 'Part',
    partsCount: '{0} parts',
    statusAction: 'Status',
    ...
    reserved: 'Reserved',
    tableNote: 'Note',
    notePlaceholder: 'e.g. Reservation at 19:00',
    searchProducts: 'Search products',
    noSearchResults: 'No matches for “{0}”.',
  ...
  sk: {
    ...
    deleteOrder: 'Vymazať túto platbu',
    ...
    pinSection: 'PIN (Menu, Prehľad, História)',
    ...
    splitTitle: 'Rozdeliť stôl',
    firstPartName: 'Názov prvej časti',
    secondPartName: 'Názov druhej časti',
    newPartName: 'Názov novej časti',
    mergeSplit: 'Zrušiť rozdelenie',
    mergeShort: 'Zlúčiť',
    mergeTitle: 'Zlúčiť časti',
    mergePickHint: 'Ťukni na časť, ktorá sa zlúči do „{0}“.',
    mergeAll: 'Zrušiť celé rozdelenie',
    part: 'Časť',
    partsCount: '{0} časti',
    statusAction: 'Stav',
    tableStatus: 'Stav stola',
    reserved: 'Rezervované',
    tableNote: 'Poznámka',
    notePlaceholder: 'napr. Rezervácia o 19:00',
    searchProducts: 'Hľadať produkt',
    noSearchResults: 'Nič sa nenašlo pre „{0}“.',
